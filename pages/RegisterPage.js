class RegisterPage {
    ...
    constructor(page) {
        ...
        //Already register email message
        this.alreadyRegMsg = page.getByText("Email Address already exist!");
        ...
        this.userCompanyName = page.locator("#company");
        this.address1Inp = page.locator("#address1");
        this.address2Inp = page.locator("#address2");
        this.countryDrpDown = page.locator("#country");
        this.stateInp = page.locator("#state");
        this.cityInp = page.getByLabel("City ");
        this.zipcodeInp = page.locator("#zipcode");
    ...
    getAlreadyAcoountCreatedMsg() {
        return this.alreadyRegMsg;
    }
